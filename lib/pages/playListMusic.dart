...
class _PlayListMusicState extends State<PlayListMusic> {
  ...
  Future<void> _initializeTrack() async {
    var tracks = Provider.of<AudioPLayerProvider>(context).getTrackList;
  ...
  Widget build(BuildContext context) {
    list = Provider.of<AudioPLayerProvider>(context).getTrackList;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:
                              Image.network(width: imageSize, height: imageSize,
